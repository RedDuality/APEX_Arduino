...
const int PIEZO1_PIN = 39; // Analog pin connected to the piezo
const int PIEZO2_PIN = 36; // Analog pin connected to the piezo
const int PIEZO3_PIN = 35; // Analog pin connected to the piezo
